...
|       | be removed          |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
|    8. | create test         | [[https://github.com/vlead/vlabs-landing-pages/issues/32][#32]]    |          |        |            |            |          |           |
|       | open-edx instance   |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
|    9. | Deploy all the      | [[https://github.com/vlead/vlabs-landing-pages/issues/33][#33]]    |          |        |            |            |          |           |
|       | labs on test        |        |          |        |            |            |          |           |
|       | open-edx instance   |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
|   10. | Remove theming      | [[https://github.com/vlead/vlabs-landing-pages/issues/34][#34]]    |        8 |        |            |            | backlog  | Balamma   |
|       | from test           |        |          |        |            |            |          |           |
|       | instance of         |        |          |        |            |            |          |           |
|       | open-edx            |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
|   11. | Add a new row to    | [[https://github.com/vlead/vlabs-landing-pages/issues/35][#35]]    |        8 |        |            | 13-09-2017 | backlog  | Mrudhvika |
|       | 'hosting_info'      |        |          |        |            | 13-09-2017 |          |           |
|       | of 'lab' table      |        |          |        |            |            |          |           |
|       | and update          |        |          |        |            |            |          |           |
|       | 'hosted_on' to      |        |          |        |            |            |          |           |
|       | 'test-open-edx'     |        |          |        |            |            |          |           |
...
|       | the Labs in LDS.    |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
|   16. | Ability to display  | [[https://github.com/vlead/vlabs-landing-pages/issues/3][#3]]     |          |        |            |            |          |           |
|       | all Discipline and  |        |          |        |            |            |          |           |
|       | Domain wise labs    |        |          |        |            |            |          |           |
|-------+---------------------+--------+----------+--------+------------+------------+----------+-----------|
| Total |                     |        |      148 |        |            |            |          |           |
