...
** Register and Sign In
   Registration and Sign In to Open edX platfrom is tied
   from the portal.   This ensures that when a lab that is
   not hosted on Open edX platform is accessed, the user is
   forced to go through the registration/sign-in similar to
   a lab hosted on Open edX platform.
