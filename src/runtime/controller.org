...
var expPromise;
var getExp = function() {
  expPromise = expPromise || getJSON(expUrl);
...
#+END_SRC
* Get and display lab and exp count from lds
#+name: fill-lab-exp-count
#+BEGIN_SRC js
var fillLabExpCount = function() {
  getExp()
...
var displayexpCount = function(data) {
  document.getElementById("expDisplay").innerText = data.toLocaleString();
};
