...
#+END_SRC
* Filter Phase-2 Labs
  This function filters phase2 labs from list of all
  labs. =phaseLength= and =phaseId= are the configuration
  variables.
...
var displayLogUsage = function(data) {
  document.getElementById("logUsageDisplay").innerText = data["usage"].toLocaleString();
};
