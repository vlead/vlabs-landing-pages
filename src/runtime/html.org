...
<div class="row">
  <div class="features">
    <div style="visibility: visible;
      ...
      <div class="feature-wrap">
        <h3 class="text-h3-darkblack-bold"
            style="text-align: center;">Labs
          <span id="labDisplay"></span> <sup>+</sup></h3>
      </div>
    </div>
    <div class="features">
      <div style="visibility: visible; animation-duration:
        ...
        <div class="feature-wrap">
          <h3 class="text-h3-darkblack-bold"
              style="text-align: center;">Experiments
            <span id="expDisplay"></span> <sup>+</sup></h3>
        </div>
      </div>
      <div style="visibility: visible; animation-duration:
              1000ms;
    ...
    <div style="visibility: visible;
      ...
      <div class="feature-wrap">
        <h3 class="text-h3-darkblack-bold"
        style="text-align: center;">Active Users
          <span id="displayUsersCount"></span><sup>+</sup></h3>
      </div>
    </div>
