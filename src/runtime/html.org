...
<html>
  <head>
    ...
    <script>
      ...
      msg = window.parent.postMessage("all-disciplines", "http://localhost:8000");
      }
    </script>
  </head>
  <body onpageshow="testDiscFunc()">
    <div id="contentDiv" class="container-fluid" style="padding-top:5em" >
    </div>
  </body>
</html>
...
<html>
  <head>
    ...
    <script>
      document.domain="localhost"
      function testInstFunc(){
      console.log("institutes on page show called");
      msg = window.parent.postMessage("all-institutes", "http://localhost:8000");
       }
    </script>

  </head>
  <body onpageshow="testInstFunc()">
  <div id="contentDiv" class="container-fluid" style="padding-top:5em" >
    </div>
  </body>
</html>
...
<html>
  <head>
    ...
    <script>
      document.domain="localhost"
      function testLabsFunc(){
      console.log("labs on page show called");
      msg = window.parent.postMessage("all-labs", "http://localhost:8000");
       }
    </script>

  </head>
  <body onpageshow="testLabsFunc()">
  <div id="contentDiv" class="container-fluid" style="padding-top:5em" >
    </div>
  </body>
</html>
