...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div style="float:left;"><img onclick="getLabsByInstituteName(this)" src="' + image_path +'" id="' + institute_name + '"></div>';
    });
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      disciplines += '<div style="float:left;"><img onclick="getLabsByDisciplineName(this)" src="'+ image_path +'" id="' + discipline_name + '"></img><p>'+ discipline_name +'</p></div>';
    });
