        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a onclick="setRegisterUrlInIframe();"><span class="glyphicon glyphicon-user"></span>Register</a></li>
              <li><a class="glyphicon glyphicon-log-in"> Login</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
...
#+END_SRC
** Set register url to Iframe
#+NAME: set-register-url-to-content-iframe
#+BEGIN_SRC javascript 
var setRegisterUrlInIframe = function() {
