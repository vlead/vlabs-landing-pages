...
** Loading all disciplines
   ...
   =setContentInIframe(disciplines)= in the content iframe.
...
** Loading all institutes
   ...
   =setContentInIframe(institutes)= in the content iframe.#+NAME:
   load-all-institutes
#+BEGIN_SRC javascript 
...
** Loading all labs
   ...
   =setContentInIframe(labs)= in the content iframe.#+NAME: load-all-institutes
#+NAME: load-all-labs
#+BEGIN_SRC javascript 
