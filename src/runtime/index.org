...
** Index page on load 
   An index page will load initially with a header iframe and content iframe.
...
var insertHeaderIFrame = function() {
  ...
  newFrame = createNewIframe("headerIframe", "headerIframe", "100%", "30%");
  division = document.getElementById("headerDiv");
...
var insertContentIFrame = function() {
  ...
  division = document.getElementById("contentDiv");
  insertFrameInDivision(newFrame, division.id);
};
...
var setNewContentInIframe = function(disciplines) {
  console.log("=======setting new content to content iframe=====");        
  console.log(disciplines);
  console.log(document.getElementById(window.name));
  var elem = parent.document.getElementById("contentIframe");
  console.log("elem = " + elem);
  console.log("new htdfdfml = " + disciplines);
  elem.contentDocument.write(disciplines);
//    setTimeout(setContent, 100);
};
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      disciplines += value['discipline_name'];
...
** Re Welcome
#+BEGIN_SRC html :tangle templates/re_welcome.html :eval no :noweb yes
