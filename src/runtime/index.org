...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><div  class="thumbnail" style="padding: 0px !important;"> <a><img class="img-responsive" onclick="getLabsByInstituteName(this)" src="'
      + image_path +'" id="' + institute_name +
      '"></a><div class="caption" style="min-height: 110px;"><h4 style="text-align:center; color:#2c99ce;">'+ institute_name +'</h4></div></div></div>';
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    disciplines += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"> <div class="thumbnail"  style="padding: 0px !important;"> <a><img class="img-responsive"onclick="getLabsByDisciplineName(this)" src="'
    + image_path +'" id="' + discipline_name + '"></a><div class="caption" style="min-height: 110px;"><h4 style="text-align:center; color:#2c99ce;  ">'+ discipline_name +'</h4></div></div></div>';
    });
