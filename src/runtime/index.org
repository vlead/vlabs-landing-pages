...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      disciplines += '<img onclick="getLabsByDiscipline("'+ discipline_name +'")" src="'
        + image_path +'" id="' + discipline_name + '"></img><p>'+ discipline_name +'</p>';
      //      disciplines += '<img src="' + image_path +'" id="' + discipline_name
        //+ '"></img><p>'+ discipline_name +'</p>';
    });
...
#+BEGIN_SRC javascript :tangle static/js/main.js :eval no :noweb yes 
function getLabsByDiscipline(discipline_name) {
