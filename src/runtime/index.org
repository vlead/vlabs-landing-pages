...
<html>
  <iframe width="100%" height="150em"  src="./header.html" name="iframe_header"></iframe>
  <head>
  ...
  <body>
    <div class="container">
      <p><a href="https://w3schools.com" target="iframe_a">vlabs landing page</a></p>
      <iframe width="100%" height="450em"  src="./test_index.html" name="iframe_a"></iframe>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <span id="allLabs">welcome to virutal labs</span>
  </body>
</html>
#+END_SRC
...
function manage_frames(){
  console.log("manage_frames");
  var elem = document.getElementById("allLabs");
...
function getLabsbyDiscipline() {
  var x = document.getElementById("allLabs");
  console.log("x="+ x);
  manage_frames();
...
<iframe width="100%" src="demo_iframe.htm" name="iframe_a"></iframe>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="javascript:getAllLabs()" target="iframe_a">All Labs</a></li>
      </ul>
