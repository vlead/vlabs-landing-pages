...
<body>
  ...
  <script>
    ...
    items += '<li id="' + inst_name + '"><a href='+ inst_url+'>' + inst_name + '</a></li>';
    });
    ...
    items += '<li id="' + dis_name + '"><a href='+ dis_url+'>' + dis_name + '</a></li>';
    });
    ...
    items += '<div class="col-md-4" id=' + lab_name + '><a href='+ hosted_url + '>' + lab_name +'<div class="thumbnail"><img src='+ image +'></img></a></div></div>';
    console.log(value);     
    });
