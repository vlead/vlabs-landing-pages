...
<header >
  ...
  <nav class="navbar navbar-fixed-top navbar-bootsnipp animate" role="navigation" style="z-index: 9999999">
    ...
    <div class="container-fluid">
      ...
      <button onclick="loadAllLabs()">All Labs</button>-->
...
var insertHeaderIFrame = function() {
  ...
  var newFrame = createNewIframe("headerIframe", "headerIframe", "100%", "90px");
...
** Loading all labs
    On loading all labs it deletes pre loaded content iframe and creates one
   new content iframe and set values to the newly created content iframe.
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      console.log('<img onclick="getLabsByInstituteName(this)" src="' + image_path +'" id="' + institute_name + '"></img><p>'+ institute_name +'</p>');
