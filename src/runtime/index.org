...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      disciplines += '<img onclick="getLabsByDisciplineName()" src="' + image_path +'" id="' + discipline_name + '"></img><p>'+ discipline_name +'</p>';
    });
    console.log(disciplines);
    setNewContentInIframe(disciplines);
    var contentIframe = parent.document.getElementById("contentIframe");
    var script = contentIframe.contentWindow.document.createElement("script");
    var url = '../static/js/main.js';
...
#+BEGIN_SRC javascript :tangle static/js/main.js :eval no :noweb yes 
var getLabsByDisciplineName = function() {
  alert( "Hello World");
};
#+END_SRC
