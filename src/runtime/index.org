...
<html>
  ...
  <body onload="loadIndex()">
    ...
    <div id="contentDiv" style="height:40em;"></div>
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><a class="thumbnail"><img onclick="getLabsByInstituteName(this)" src="' + image_path +'" id="' + institute_name + '"></a></div>';
    });
    var institute_list = '<html><head></head><body><div class="container"><div class="row"><div class="col-lg-12">'
        + institutes +'</div></div></div></body></html>';
...
var addScriptTags = function(){
  ...
  bootstrap_styles.type = "text/stylesheet";
  bootstrap_styles.href = bootstrap_css_url;
  var body = contentIframe.contentWindow.document.body;
  console.log(body);
  body.appendChild(bootstrap_styles);
