                  ...
                  <ul class="dropdown-menu mega-dropdown-menu">
                    ...
                    <li class="col-sm-2">
                      <ul>
                        ...
                        <a href="#">Online</a>
                        <a href="#">College Cloud Edition</a>
                     </ul>
                    </li>
                    <li class="col-sm-3">
                      <ul>
                        ...
                        <a href="#">Virtuals College Cloud Edition</a>
                        <a href="#">Expression of Interest for Workshops</a>
                      </ul>
                    </li>
                    <li class="col-sm-2">
                      <ul>
                        ...
                        <a href="#">Contact us</a>
                        <a href="#">2017-summer-intership</a>
                      </ul>
                    </li>
                </li>
                </ul>
