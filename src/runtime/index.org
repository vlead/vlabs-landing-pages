...
//        '</h4></div></a></div></div>';
        ...
        labs += '<div class="col-md-3" id='+ lab_name +
        '> <div class="thumbnail" style="padding: 0px !important;" ><a><img class="img-responsive" id='+hosted_url+' onclick="getLab(this)" src="' + path +
        '"alt="image"/><div class="caption" style="min-height: 110px;" ><h4 style="text-align:left; color:#2c99ce;">'+lab_name +
            '</h4></div></a></div></div>';
