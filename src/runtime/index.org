        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="http://content.base5.vlabs.ac.in/register"
                     target="content_iframe"><span class="glyphicon glyphicon-user"></span>Register</a></li>
              <li><a class="glyphicon glyphicon-log-in" href="http://content.base5.vlabs.ac.in/login"> Login</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
