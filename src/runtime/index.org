...
var insertHeaderIFrame = function() {
  ...
  var newFrame = createNewIframe("headerIframe", "headerIframe", "100%", "800px");
...
** Get All Institutes
   This function will be invoked when =All Institutes= tab is clicked. It
   invokes a call to =LDS= database and fetches all the institutes info and
   calls =setNewContentInIframe()= function to display the data in an
   iframe. Also calls =addScriptTags()= function to append =main.js=, =jquery=
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    var institute_list = '<div>'+ institutes +'/<div>';
...
#+END_SRC
** Get All Disciplines
   This function will be invoked when =All Disciplines= tab is clicked. It
   invokes a call to =LDS= database and fetches all the disciplines info and
   calls =setNewContentInIframe()= function to display the data in an
   iframe. Also calls =addScriptTags()= function to append =main.js=, =jquery=
   and =app-config= to =<head>= tag as =<script>=.
