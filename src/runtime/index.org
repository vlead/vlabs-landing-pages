...
<body>
  ...
  <script>
    var url = 'http://localhost:5000/institutes';
    $.getJSON(url , function(data) {
    var items = '';
    $.each(data, function(key, value){
    inst_name = value['institute_name']
    items += '<li id="' + inst_name + '"><a href='+ url+'>' + inst_name + '</a></li>';
    });
    ...
    items += '<div class="row"><div class="col-sm-4" id="' + lab_name + '"><a href='+ hosted_url+'>' + lab_name + '</a></div>';
    });
