  ...
  <body>
    <div class="container">
      ...
      <iframe id="contentIframe" width="100%" height="450em"
              src="content_iframe.html" name="content_iframe">
      </iframe>
    </div>
  </body>
</html>
...
// event.preventDefault()       
 ...
 //  $.getJSON("http://localhost:5000/labs?keyword_lab_name=computer", function() {
//    console.log("HI");
//    console.log(lab_url);
//    alert(data['return']);
//    var labs = '';
...
/*  $.ajax("http://localhost:5000/labs?keyword_lab_name=" + keyword, function(data){
//jQuery.ajax(lab_url, function(data){
...
$.ajax({
                      type: "GET",
                                          url: "http://localhost:5000/labs?keyword_lab_name=computer",
                                          async: false,
