...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../static/css/bootsnipp.css">
    <link rel="stylesheet" href="../static/css/bootsnipp.css">
    <link rel="stylesheet" href="../static/css/bootsnipp.css">
    <link rel="stylesheet" href="../static/files/bootstrap.css">
    <link rel="stylesheet" href="../static/files/font-awesome.css">
    <link rel="stylesheet" href="../static/files/bootsnipp.css">
    <script src="../staticfiles/jquery-1.js"></script>
    <script src="../static/files/bootstrap.js"></script>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="">
          <a href="http://vlabs.ac.in:5959/workshops/" class="dropdown-toggle " data-toggle="dropdown" aria-expanded="false">Workshops<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">

            <li class=""><a href="http://vlabs.ac.in:5959/workshops/" class="">Online</a></li>
           <li class=""><a href="http://vlabs.ac.in:5959/college-cloud-edition/" class="">College Cloud Edition</a></li>

          </ul>
        </li> 
        <!--<li class="">
          <a href="" class="dropdown-toggle " data-toggle="dropdown" aria-expanded="false">Development<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">

            <li class=""><a href="http://dev.vlabs.ac.in/" class="">Virtual Labs Development </a></li>
        ...
        <li class="">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class=""><a href="https://plus.google.com/communities/104131148292250423165" class="">Teachers</a></li>
            <li class=""><a href="https://groups.google.com/a/vlabs.ac.in/forum/#!forum/engineers" class="">Developers </a></li>
	    <li class=""><a href="https://groups.google.com/a/vlabs.ac.in/forum/#!forum/users" class="">Students </a></li>
         ...
         <li class="">
          ...
          <ul class="dropdown-menu" role="menu">
	    <li class=""><a href="http://vlabs.ac.in:5959/faq/index.html" class="">Virtual Labs</a></li>
            <li class=""><a href="http://vlabs.ac.in:5959/faq/index.html" class="">Virtual Labs College Cloud Edition</a></li>
            <li class=""><a href="http://vlabs.ac.in:5959/faq/index.html" class="">Expression of Interest For Workshops</a></li>
...
<div >
<iframe id="headerIframe" id="logo" width="100%" allowtransparency="true" height="450px" frameborder="0" src="header.html" name="header_iframe" style="positon:relative; z-index:999;"></iframe>
<!--<div class="col-md-12 container-fluid"><img src="../static/img/bg1.jpg" style="width:100%; height:430px;"></div>-->
</div>
    <div class="container" style="positon:relative; z-index:698;">    
      <iframe id="contentIframe" width="100%" style="positon:relative; z-index:998;" height="100%" frameborder="0" src="content_iframe.html" name="content_iframe"></iframe>
    </div>
