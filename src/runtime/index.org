...
** Header
   ...
   =getAllInstitutesInCombobox()=, =getAllDisciplinessInCombobox()= and
...
<html>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle "
                     ...
                     aria-expanded="false">Institutes <span class="caret"></span></a>
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle "
                     data-toggle="dropdown"
                     id="getDisciplineName"
                     aria-expanded="false">Disciplines
  ...
  <li><a style="pointer-events: none;"
         href="http://vlabs.ac.in"
         target="content_iframe"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
  <li><a style="pointer-events: none;" href="#">
...
<img src="http://files.vlabs.ac.in/lds/images/slider-images/slider-img-01.jpg"
                     class="img-responsive main-logo"
                     style="width:100%; maring-top:2px;">
<div class="row">
  <div class="features">
...
animation-name: fadeInDown;"
      ...
      <div class="feature-wrap">
        <h3 class="text-h3-darkblack-bold"
            style="text-align: center;">  Labs 180<sup>+</sup> </h3>
      </div>
    </div>
    ...
    <div class="features">
      ...
      <div style="visibility: visible; animation-duration:
        ...
        <div class="feature-wrap">
          <h3 class="text-h3-darkblack-bold"
              style="text-align: center;">
            <a href="https://info.vlabs.ac.in/analytics/analytics/usage.html"
               class="broad-labs-a" target="_blank">Workshop Usage</a>
...
var setNewContentInIframe = function(data) {
  ...
  var element = parent.document.getElementById("contentIframe");
  element.sandbox = 'allow-forms allow-scripts allow-same-origin';
  console.log("element = " + element);
  console.log("new htdfdfml = " + data);
  element.contentDocument.write(data);
};
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><a class="thumbnail" href="#"><img class="img-responsive" onclick="getLabsByInstituteName(this)" src="'
        + image_path +'" id="' + institute_name +
        '"><p style="text-align:center;">'+ institute_name +'</p></a></div>';
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    disciplines += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"> <a class="thumbnail" href="#"><img class="img-responsive"onclick="getLabsByDisciplineName(this)" src="'
    + image_path +'" id="' + discipline_name + '"><p style="text-align:center;">'+ discipline_name +'</p></a></div>';
    });
...
var getAllLabs = function(){ 
  ...
  $.getJSON(lab_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-sm-3 col-md-3 col-xs-6 thumb" id='+ lab_name +
        '><a class="thumbnail" href='+ hosted_url +
        '><img class="img-responsive" src="' + path +
        '"alt="image"/><a href='+ hosted_url +
        '><p style="text-align:center;">'+lab_name +
        '</p></a></div>';
