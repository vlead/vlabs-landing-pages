...
* Web App
** Index HTML
   The App is used to get the content based on Institutes, Disciplines, All
   labs. Here's the basic skeleton. 
...
var base_url = 'http://lds.vlabs.ac.in';
...
** Iframe
#+BEGIN_SRC html :tangle templates/test_iframe.html :eval no :noweb yes 
<!DOCTYPE html>
<html>
<body>
...
#+END_SRC
** Footer
   Footer service is merged in this application
