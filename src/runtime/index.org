...
<html lang="en">
  ...
  <body onload="loadIndex()">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a  href="#" class="dropdown-toggle" data-toggle="dropdown">Disciplines <b class="caret"></b></a>
    ...
    <div id="contentDiv" style="padding-top:172px;">
    </div>
    <div id="footerDiv">
    </div>
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><div  class="thumbnail"> <a href="#"><img class="img-responsive" onclick="getLabsByInstituteName(this)" src="'
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    disciplines += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"> <div class="thumbnail"> <a  href="#"><img class="img-responsive"onclick="getLabsByDisciplineName(this)" src="'
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes +=  '<li onclick="getLabsByInstituteName(this)" value="'
        + institute_name + '" id="' + institute_name + '"><a href="#">' +
        institute_name + '</a></li>';
    });
    var institute_list = '<li onclick="loadAllInstitutes()">\
<a href="#">All Institutes</a></li>' + institutes;
  ...
  $.getJSON(discipline_url, function(data) {
    ...
    var discipline_name = value['discipline_name'];
      disciplines += '<li onclick="getLabsByDisciplineName(this)" value="'
        + discipline_name + '" id="' + discipline_name + '"><a href="#">' +
        discipline_name + '</a></li>';
    });
    var discipline_list = '<li onclick="loadAllDisciplines()">\
<a href="#">All Disciplines</a></li>' + disciplines;
