  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><a class="thumbnail" href="#"><img class="img-responsive" onclick="getLabsByInstituteName(this)" src="'
        ...
        '"><p style="text-align:center; color: #888; font-size:14px; ">'+ institute_name +'</p></a></div>';
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    + image_path +'" id="' + discipline_name + '"><p style="text-align:center; color: #888">'+ discipline_name +'</p></a></div>';
    });
