...
function getAllLabs() {
  console.log("get all labs by keyword");
...
function getLabsByLabNameKeyword(){
  console.log("=====dfasddfsddf======");
  getAllLabs();
        ...
        <form class="navbar-form navbar-left">
          <div class="input-group">
            ...
            <div class="input-group-btn">
              <button onclick="javascript:getLabsByLabNameKeyword()"
            target="body_iframe" class="btn btn-default" type="submit">
