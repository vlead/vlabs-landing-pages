...
institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb" class="cursor-pointer" onclick="getLabsByInstituteName(this, 0)"  src="' + image_path +'" id="' + institute_name +
      '" style="cursor:pointer;"><div  \
class="thumbnail" style="padding: 0px !important; padding-top:15px !important;"> <a><img class="img-responsive " onclick="getLabsByInstituteName(this, 0)"  src="' + image_path +'" id="' + institute_name +
      '"><div class="caption" style="min-height: 110px;">\
<h4 onclick="getLabsByInstituteName(this, 0)"  src="' + image_path +'" id="' + institute_name +
      '" style="text-align:center; color:#2c99ce; cursor:pointer;" >'+ institute_name +'</h4></a></div></div></div>';
          });
...
onclick="getLabsByDisciplineName(this, 0)" src="'
    + image_path +'" id="' + discipline_name + '">\
<div class="caption" style="min-height: 110px;">\
<h4 onclick="getLabsByDisciplineName(this, 0)" src="'
    + image_path +'" id="' + discipline_name + '" style="text-align:center; color:#2c99ce; cursor: pointer; ">'
