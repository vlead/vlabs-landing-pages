...
class="thumbnail" style="padding: 0px !important; padding-top:15px !important;"> <a><img class="img-responsive" \
onclick="getLabsByInstituteName(this, 0)" src="' + image_path +'" id="' + institute_name +
      '"></a><div class="caption" style="min-height: 110px;">\
<h4 style="text-align:center; color:#2c99ce;">'+ institute_name +'</h4></div></div></div>';
