...
<html lang="en">
  <head>
    ...
    <script>
      document.domain="base5.vlabs.ac.in";

      <!-- document.cookie = "loginHandler=''"; -->
      <!-- var loginHandler = ""; -->
      function displayMessage (evt) {
           var message;
           if (evt.origin !== "http://content.base5.vlabs.ac.in") {
                  message = "Unauthorized domain";
               }
           else {
                 if (evt.data.includes("FIND COURSES")){
                     loginHandler = "logged in";
                     document.cookie = "loginHandler='logged in'";
                 }
                 else if (evt.data.includes("Sign in")){
                     loginHandler = "logged out";
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li >
                <a onclick="loadAllLabs()" "#" class="dropdown-toggle" data-toggle="dropdown">All Labs <b ></b></a>
              </li>
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown">Institutes <b class="caret"></b></a>
                <ul class="dropdown-menu filterInstituteComboBox" id="getInstituteName" >
                </ul>
                
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown">Disciplines <b class="caret"></b></a>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a onclick="setRegisterUrlInContentIframe();"><span class="glyphicon glyphicon-user"></span>Register</a></li>
              <li><a onclick="setLoginUrlInContentIframe('login');" id="login" class="glyphicon glyphicon-log-in"> Login</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
...
<div class="row">
  <div class="features">
    ...
    <div id="contentDiv" class="container-fluid" style="padding-top:4em" >
    </div>
...
var setRegisterUrlInContentIframe = function() {
  console.log("=======setting registre url to content iframe=====");        
  var iframe = document.getElementById("contentIframe");
  iframe.src = "http://content.base5.vlabs.ac.in/register";
...
var setLoginUrlInContentIframe = function(event) {
  ...
  var iframe = document.getElementById("contentIframe");
  if(event == "login"){
      iframe.src = "http://content.base5.vlabs.ac.in/login";
      iframe.sandbox = 'allow-forms allow-scripts allow-same-origin';
  }
  else{
      iframe.src = "http://content.base5.vlabs.ac.in/logout";
      document.getElementById("login").innerHTML = "Login";
      document.getElementById("login").setAttribute( "onClick", "setLoginUrlInContentIframe('login')" );
...
var getAllInstitutes = function(){ 
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><div  class="thumbnail"> <a><img class="img-responsive" onclick="getLabsByInstituteName(this)" src="'
      + image_path +'" id="' + institute_name +
      '"></a><div><p style="text-align:center; color: #888; ">'+ institute_name +'</p></div></div></div>';
...
var getAllDisciplines = function(){ 
  ...
  $.getJSON(dis_url, function(data) {
    ...
    disciplines += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"> <div class="thumbnail"> <a><img class="img-responsive"onclick="getLabsByDisciplineName(this)" src="'
    + image_path +'" id="' + discipline_name + '"></a><div ><p style="text-align:center; color: #888; ">'+ discipline_name +'</p></div></div></div>';
    });
...
var getAllInstitutesInCombobox = function(){
  ...
  $.getJSON(institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      var institute_name = value['institute_name'];
      institutes +=  '<li onclick="getLabsByInstituteName(this)" value="'
...
var getAllDisciplinesInCombobox = function(){
  ...
  $.getJSON(discipline_url, function(data) {
    ...
    $.each(data, function(key, value){
    var discipline_name = value['discipline_name'];
      disciplines += '<li onclick="getLabsByDisciplineName(this)" value="'
...
var js_script = iframe.contentWindow.document.createElement("script");
  var js_url = "../static/js/main.js";
  js_script.type = "text/javascript";
  js_script.src = js_url;
  ...
  var config_script = iframe.contentWindow.document.createElement("script");
  var config_url = "../static/js/app-config.js";
  config_script.type = "text/javascript";
  config_script.src = config_url;
  head.appendChild(config_script);
  
  var jquery_script = iframe.contentWindow.document.createElement("script");
  var jquery_url = "https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js";
  jquery_script.type = "text/javascript";
  jquery_script.src = jquery_url;
  head.appendChild(jquery_script);  

  var bootstrap_js = iframe.contentWindow.document.createElement("script");
  var bootstrap_js_url = "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js";
  bootstrap_js.type = "text/javascript";
  bootstrap_js.src = bootstrap_js_url;
  head.appendChild(bootstrap_js);  
  ...
  var bootstrap_styles = iframe.contentWindow.document.createElement("link");
  var bootstrap_css_url = "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css";
  bootstrap_styles.rel = "stylesheet";
  bootstrap_styles.href = bootstrap_css_url;
  head.appendChild(bootstrap_styles);

  var favicon = iframe.contentWindow.document.createElement("link");
  var favicon_url = "";
  favicon.type = "image/x-icon";
  favicon.href = favicon_url;
  head.appendChild(favicon);
...
/*the following css used for nav bar*/
    body {
		padding: 60px 0px;
	}
	.navbar-collapse {
...
#+END_SRC
**** Header JS
#+BEGIN_SRC javascript :tangle static/js/header.js :eval no :noweb yes 
<<set-content>>
<<reset-content>>
<<favicon>> 
