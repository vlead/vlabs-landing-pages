...
style="padding: 0px !important;"> <a><img class="img-responsive"\
onclick="getLabsByDisciplineName(this, 0)" src="'
    + image_path +'" id="' + discipline_name + '">\
</a><div class="caption" style="min-height: 110px;">\
<h4 style="text-align:center; color:#2c99ce;  ">'
        + discipline_name +'</h4></div></div></div>';
    });
