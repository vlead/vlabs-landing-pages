          ...
          <nav class="navbar ">
            ...
            <div class="collapse navbar-collapse js-navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li>
                  <a href="#" class="dropdown-toggle " data-toggle="dropdown"  aria-expanded="false">Institutes <span class="caret"></span></a>
                  <ul class="dropdown-menu filterInstComboBox" id="getInstName" >
                  </ul>
                </li>
                <li class="">
                  <a href="#" class="dropdown-toggle " data-toggle="dropdown" id="getDisName" aria-expanded="false">Disciplines <span class="caret"></span></a>
                  <ul class="dropdown-menu filterDisComoBox">
                  </ul>
                </li>
  ...
  <form class="navbar-form navbar-left">
    <div class="input-group">
      ...
      <div class="input-group-btn">
        <button style="pointer-events: none;" onclick="javascript:getLabs()" target="content_iframe" class="btn btn-default" type="submit">
          <i class="glyphicon glyphicon-search"></i>
        </button>
      </div>
    </div>
  </form>
  <li><a style="pointer-events: none;" href="http://vlabs.ac.in" target="content_iframe"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
  <li><a style="pointer-events: none;" href="#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
</ul>
</div>
<!-- /.nav-collapse -->
</nav>
  ...
  $.getJSON(lab_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-lg-3 col-md-4 col-xs-6 thumb" id='
        ...
        '" width="250px" height="160px" alt="image"/><p style="text-align:center;">'
        +lab_name +'</p> </a></div>';      
    });
    console.log(labs);
...
var getLabsByDisciplineName = function(image) {
  ...
  $.getJSON(labs_by_dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-sm-3" id=' + lab_name +
        '><a class="thumbnail" href='+ hosted_url +
        '><img class="img-responsive" src="'+ path +
        '" width="250px" height="160px" alt="image"/><p style="text-align:center;">'
        + lab_name +'</p></a></div></div>';
    });
    console.log(labs);
  ...
  $.getJSON(labs_by_institute_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-sm-3" id=' + lab_name + 
        '><a class="thumbnail" href='+ hosted_url +
        '><img class="img-responsive" src="' + path +
        '" width="250px" height="160px" alt="image"/><p>'
        +lab_name +'</p></a></div></div>';
...
** Load All Institutes in Combo box
...
<a href="#">All Institutes</a></li>' + institutes;
    ...
    $('.filterInstComboBox').append(institute_list);
  })
    .done(function() {
      console.log( "second success" );
    })
