...
institutes += '<div class="col-lg-3 col-md-4 col-xs-6 thumb"><div  \
class="thumbnail" style="padding: 0px !important; padding-top:15px !important;"> <a><img class="img-responsive cursor-pointer" onclick="getLabsByInstituteName(this, 0)"  src="' + image_path +'" id="' + institute_name +
      '"><div class="caption" style="min-height: 110px;">\
<h4 class="cursor-pointer" onclick="getLabsByInstituteName(this, 0)"  src="' + image_path +'" id="' + institute_name +
