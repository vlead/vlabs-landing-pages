...
var getAllLabs = function(){ 
  ...
  $.getJSON(lab_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-lg-3 col-md-4 col-xs-6 thumb" id=' + lab_name + '><a class="thumbnail" href='+ hosted_url + '><img class="img-responsive" src="'
        + path +'" width="250px" height="160px" alt="image"/><p style="text-align:center;">'
        +lab_name +'</p> </a></div>';      
    });
    console.log(labs);
  ...
  $.getJSON(labs_by_dis_url, function(data) {
    ...
    $.each(data, function(key, value){
      ...
      labs += '<div class="col-sm-3" id=' + lab_name + '><a href='+ hosted_url + '><img src="'
        + path +'" width="250px" height="160px" alt="image"/> </a><p style="text-align:center;">'
        +lab_name +'</p></div></div>';
    });
    console.log(labs);
