...
//function getLabsByInstitute() {
//  new_html =  "<html><head></head><body><p> Institute </p></body></html>";
//  manageFrames(new_html);
//}

//function getAllLabs() {
//  new_html =  "<html><head></head><body><p> All Labs </p></body></html>";
//  manageFrames(new_html);
//}
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="javascript:getLabsByInstitute()"
               target="body_iframe">Institutes</a></li>

        <li><a href="javascript:getLabsByDiscipline()"
               target="body_iframe">Disciplines</a></li>
