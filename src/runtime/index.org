...
* Web App
** Index HTML
   This is the index page with a body iframe where all the results will be loaded.
...
#+BEGIN_SRC html :tangle templates/body_iframe.html :eval no :noweb yes
<html>
  <head>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
...
*** Display All Labs By Discipline
    ...
    displays the result in the body iframe.
