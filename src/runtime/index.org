...
<html>
  ...
  <body>
    <div class="container">
      ...
      <iframe id="contentIframe" width="100%" height="450em" src="content_iframe.html" name="content_iframe"> </iframe>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <div id="content">welcome to virtual labs</div>
  </body>
</html>
...
#+BEGIN_SRC javascript :tangle static/js/main.js :eval no :noweb yes
  ...
  jQuery.support.cors = true;
      ...
      $.ajax({
          ...
          type: "GET",
          url: base_url + "/labs?keyword_lab_name=" + keyword,
          async: false,
...
success : function(json){
   iframe.src = "http://localhost:8000/templates";
   //$.load('http://www.mit.edu');
...
//  manageNewFrame(labs);
  ...
  var elem = parent.frames["content_iframe"].document.getElementById("content");
  console.log("elem = " + elem);
  console.log("new htdfdfml = " + labs);
  elem.innerHTML = labs;
  ...
  <nav class="navbar navbar-fixed-top navbar-bootsnipp animate" role="navigation" style="z-index: 9999999">
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://54.193.74.107/register" target="content_iframe"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        <!--<li><a href="https://www.iitbombayx.in/register" target="content_iframe"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>-->
